...
namespace HomeService
{
    ...
    public class SmartHomeService : ISmartHomeService
    {
        ...
        public async Task<string[]> MakeAction(string[] ID, string type, string Action, string Parametr)
        {
            ...
            result = await controller.MakeActionAcyns();
            return result;
        }
        ...
        {
            IDevice device = new TemperatureDevice("1");///такоє собі
            if (type == "Tempr")
            {
